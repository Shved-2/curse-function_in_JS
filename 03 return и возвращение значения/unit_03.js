...
function t5() {
  ...
  let symb = document.querySelector('.s52').value;
...
function t21(s) {
  ...
  if (num % 2 === 0 && s == 'even') {
    return num;
  } else if (num % 2 !== 0 && s == 'even') {
    return num + 1;
  } else if (num % 2 !== 0 && s == 'odd') {
    return num;
  } else if (num % 2 === 0 && s == 'odd') {
    return num == 20 ? num - 1 : num + 1;
  }
}
...
function t26() {
  let inp26 = document.querySelector('.i-26').value;
  let out = document.querySelector('.out-26');

  if (inp26.trim() != '') {
    out.innerHTML = inp26.trim().toLowerCase();
  }
  return;
}
